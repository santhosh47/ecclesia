...
def seed_church_data(db: Session = Depends(get_db)) -> dict[str, str]:
    ...
    members_data = [
        ...
        Member(first_name="Ruth", last_name="Sterling", title="Mrs", email="ruth.sterling@example.com", phone="+91 98450 11003", address="14 2nd Cross, Koramangala", city="Bangalore", state="KA", postal_code="560034", gender="Female", marital_status="Widowed", occupation="Retired Educator", avatar_url="https://images.unsplash.com/photo-1581579438747-1dc8d17bbce4?w=150", status="Active", member_type="Senior", pan_number="AAAPS1234G", language_preference="English", date_of_birth=date(1952, 3, 25), baptism_date=date(1968, 4, 10), joined_date=date(2015, 1, 10), household_id=households_data[0].id, household_role="Parent", notes="Mother living with David and Grace Sterling. Active in prayer ministry."),
