...
def seed_church_data(db: Session = Depends(get_db)) -> dict[str, str]:
    ...
    members_data = [
        ...
        Member(first_name="Carlos", last_name="Morales", title="Mr", email="carlos.morales@example.com", phone="+91 98450 33001", address="504 Oak Crest Parkway", city="Bangalore", state="KA", postal_code="560025", gender="Male", marital_status="Married", occupation="Software Director", avatar_url="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150", status="Active", member_type="Adult", pan_number="AZXPM9988H", language_preference="English", date_of_birth=date(1985, bday_soon3.month, bday_soon3.day), wedding_anniversary=date(2014, 10, 25), baptism_date=date(2000, 5, 1), joined_date=date(2018, 3, 15), household_id=households_data[2].id, household_role="Head"),
        ...
        Member(first_name="Jonathan", last_name="Chen", title="Mr", email="jonathan.chen@example.com", phone="+91 98450 44001", address="89 Cedar Valley Drive", city="Bangalore", state="KA", postal_code="560066", gender="Male", marital_status="Married", occupation="Financial Analyst", avatar_url="https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=150", status="Active", member_type="Adult", pan_number="BCHPC3344J", language_preference="English", date_of_birth=date(1980, 7, 8), wedding_anniversary=date(2009, 8, 12), baptism_date=date(1996, 9, 22), joined_date=date(2016, 9, 1), household_id=households_data[3].id, household_role="Head"),
        Member(first_name="Anthony", last_name="Vargas", title="Mr", email="anthony.vargas@example.com", phone="+91 98450 55001", address="22 St. Mark's Road", city="Bangalore", state="KA", postal_code="560001", gender="Male", marital_status="Single", occupation="Freelance Photographer", avatar_url="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=150", status="Active", member_type="Adult", pan_number="AVPPM7788P", language_preference="English", date_of_birth=date(1992, 12, 1), baptism_date=date(2010, 11, 7), joined_date=date(2021, 5, 20), notes="Absent past 4 weeks due to travel."),
        Member(first_name="Hannah", last_name="Wilson", title="Miss", email="hannah.wilson@example.com", phone="+91 98450 66001", address="105 Victoria Layout", city="Bangalore", state="KA", postal_code="560047", gender="Female", marital_status="Single", occupation="Nurse", avatar_url="https://images.unsplash.com/photo-1524504388940-b1c1722653e1?w=150", status="Visitor", member_type="Adult", language_preference="English", date_of_birth=date(1995, 3, 14), first_visit_date=today - timedelta(days=7), notes="Visited first time on last Sunday."),
    ]
    ...
    activities_data = [
        ChurchActivity(
            ...
            organizer_name="Rev. Dr. Samuel Thomas",
    ...
    db.add_all([
        IssuedCertificate(certificate_number=f"CERT-BAP-{today.year}-0042", certificate_type="Baptism", member_id=members_data[4].id, recipient_name="Chloe Anderson", issue_date=date(2018, 6, 12), event_date=date(2018, 6, 12), officiant_name="Rev. Dr. Samuel Thomas", witness_1="Dr. Marcus Anderson", church_name="St. Luke's Ecclesia Church", verification_code="ECCL-BAP-7788"),
        IssuedCertificate(certificate_number=f"CERT-WED-{today.year}-0018", certificate_type="Wedding", member_id=members_data[5].id, recipient_name="Carlos Morales", secondary_name="Elena Morales", issue_date=date(2014, 10, 25), event_date=date(2014, 10, 25), officiant_name="Rev. Dr. Samuel Thomas", witness_1="David Sterling", church_name="St. Luke's Ecclesia Church", verification_code="ECCL-WED-9901"),
    ])
    db.commit()
    ...
    db.add_all([
        ...
        PastoralCareNote(member_id=members_data[8].id, author_name="Rev. Dr. Samuel Thomas", category="Pastoral Visit", content="Called Anthony to check in following his absence. He is returning to Bangalore next week.", follow_up_needed=True),
    ])
    db.commit()
